import type { M3SessionResponse, BridgeServiceRegistrationRequest, BridgeServiceResponse, BridgeServicesResponse, M3ConsentRequest, ConsentStatusResponse, HealthInformationRequest, HealthInformationResponse } from '../../types/m3/m3';
